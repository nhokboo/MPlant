angular.module('ez.timepicker').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('ez-timepicker.html',
    ...
    "      <div><a style=\"margin-bottom: -10px;\" class=\"btn\" ng-click=\"incrementHours()\"><i ng-class=\"incIconClass\"></i></a></div>\n" +
    ...
    "      <div><a style=\"margin-bottom: -10px;\" class=\"btn\" ng-click=\"incrementMinutes()\"><i ng-class=\"incIconClass\"></i></a></div>\n" +
